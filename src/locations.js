...
export const CITY_POIS = {
  ...
  morocco: {
    ...
    pack: 'morocco',
    groundElevation: 400,
    viewBounds: { southwest: { lat: 27.6, lng: -13.2 }, northeast: { lat: 35.95, lng: -1.0 } },
    pois: [
      { name: 'Hassan II Mosque', lat: 33.6086, lon: -7.6326, alt: 700, pitch: -22, heading: 210, buildingHeight: 200 },
      { name: 'Hassan Tower', lat: 34.0242, lon: -6.8227, alt: 450, pitch: -28, heading: 180, buildingHeight: 44 },
      { name: 'Koutoubia Mosque', lat: 31.6239, lon: -7.9936, alt: 500, pitch: -25, heading: 200, buildingHeight: 70 },
      { name: 'Cap Spartel', lat: 35.7881, lon: -5.9236, alt: 900, pitch: -20, heading: 0, buildingHeight: 20 },
      { name: 'Tanger Med', lat: 35.89, lon: -5.5, alt: 1800, pitch: -28, heading: 90, buildingHeight: 40 },
    ],
  },
  casablanca: {
    name: 'Casablanca',
    pack: 'morocco',
    groundElevation: 50,
    viewBounds: { southwest: { lat: 33.48, lng: -7.75 }, northeast: { lat: 33.64, lng: -7.48 } },
    pois: [
      { name: 'Hassan II Mosque', lat: 33.6086, lon: -7.6326, alt: 650, pitch: -22, heading: 210, buildingHeight: 200 },
      { name: 'Casa Port', lat: 33.5992, lon: -7.6128, alt: 500, pitch: -28, heading: 90, buildingHeight: 25 },
      { name: 'Morocco Mall', lat: 33.5764, lon: -7.7073, alt: 450, pitch: -28, heading: 0, buildingHeight: 30 },
      { name: 'Twin Center', lat: 33.5865, lon: -7.632, alt: 420, pitch: -22, heading: 40, buildingHeight: 110 },
      { name: 'Mohammed V Airport', lat: 33.3675, lon: -7.5898, alt: 1400, pitch: -30, heading: 0, buildingHeight: 20 },
    ],
  },
  rabat: {
    name: 'Rabat',
    pack: 'morocco',
    groundElevation: 75,
    viewBounds: { southwest: { lat: 33.95, lng: -6.92 }, northeast: { lat: 34.08, lng: -6.75 } },
    pois: [
      { name: 'Hassan Tower', lat: 34.0242, lon: -6.8227, alt: 420, pitch: -28, heading: 180, buildingHeight: 44 },
      { name: 'Kasbah of the Udayas', lat: 34.0319, lon: -6.8361, alt: 380, pitch: -25, heading: 270, buildingHeight: 20 },
      { name: 'Chellah', lat: 34.0064, lon: -6.8217, alt: 400, pitch: -30, heading: 0, buildingHeight: 15 },
      { name: 'Royal Palace', lat: 34.0139, lon: -6.8416, alt: 550, pitch: -30, heading: 90, buildingHeight: 25 },
      { name: 'Rabat Ville', lat: 34.0164, lon: -6.8356, alt: 350, pitch: -28, heading: 0, buildingHeight: 20 },
    ],
  },
  marrakech: {
    name: 'Marrakech',
    pack: 'morocco',
    groundElevation: 450,
    viewBounds: { southwest: { lat: 31.58, lng: -8.06 }, northeast: { lat: 31.68, lng: -7.94 } },
    pois: [
      { name: 'Jemaa el-Fnaa', lat: 31.6258, lon: -7.9891, alt: 420, pitch: -28, heading: 180, buildingHeight: 15 },
      { name: 'Koutoubia Mosque', lat: 31.6239, lon: -7.9936, alt: 480, pitch: -25, heading: 200, buildingHeight: 70 },
      { name: 'Bahia Palace', lat: 31.6216, lon: -7.9826, alt: 350, pitch: -28, heading: 45, buildingHeight: 12 },
      { name: 'Majorelle Garden', lat: 31.6417, lon: -8.0029, alt: 320, pitch: -30, heading: 0, buildingHeight: 8 },
      { name: 'Menara Gardens', lat: 31.6134, lon: -8.0206, alt: 700, pitch: -30, heading: 90, buildingHeight: 10 },
    ],
  },
  tangier: {
    name: 'Tangier',
    pack: 'morocco',
    groundElevation: 80,
    viewBounds: { southwest: { lat: 35.73, lng: -5.94 }, northeast: { lat: 35.82, lng: -5.76 } },
    pois: [
      { name: 'Grand Socco', lat: 35.7847, lon: -5.8126, alt: 380, pitch: -28, heading: 180, buildingHeight: 15 },
      { name: 'Kasbah Museum', lat: 35.7889, lon: -5.8136, alt: 350, pitch: -25, heading: 0, buildingHeight: 12 },
      { name: 'Cap Spartel', lat: 35.7881, lon: -5.9236, alt: 700, pitch: -22, heading: 310, buildingHeight: 20 },
      { name: 'Cave of Hercules', lat: 35.7594, lon: -5.9394, alt: 350, pitch: -25, heading: 270, buildingHeight: 10 },
      { name: 'Tanger Med', lat: 35.89, lon: -5.5, alt: 1800, pitch: -28, heading: 90, buildingHeight: 40 },
    ],
  },
  fez: {
    ...
    pack: 'morocco',
    groundElevation: 400,
    viewBounds: { southwest: { lat: 34.0, lng: -5.05 }, northeast: { lat: 34.09, lng: -4.94 } },
    pois: [
      { name: 'Bab Boujloud', lat: 34.0619, lon: -4.9826, alt: 320, pitch: -25, heading: 90, buildingHeight: 18 },
      { name: 'Al Quaraouiyine', lat: 34.0646, lon: -4.9733, alt: 300, pitch: -28, heading: 180, buildingHeight: 20 },
      { name: 'Chouara Tannery', lat: 34.0663, lon: -4.971, alt: 280, pitch: -30, heading: 0, buildingHeight: 8 },
      { name: 'Fes el-Bali', lat: 34.0631, lon: -4.9778, alt: 700, pitch: -35, heading: 45, buildingHeight: 12 },
      { name: 'Royal Palace Fes', lat: 34.0564, lon: -4.9936, alt: 450, pitch: -28, heading: 270, buildingHeight: 20 },
    ],
  },
  agadir: {
    name: 'Agadir',
    pack: 'morocco',
    groundElevation: 30,
    viewBounds: { southwest: { lat: 30.36, lng: -9.65 }, northeast: { lat: 30.47, lng: -9.52 } },
    pois: [
      { name: 'Agadir Marina', lat: 30.4278, lon: -9.5981, alt: 400, pitch: -25, heading: 270, buildingHeight: 15 },
      { name: 'Kasbah Agadir Oufella', lat: 30.427, lon: -9.625, alt: 450, pitch: -22, heading: 90, buildingHeight: 12 },
      { name: 'Souk El Had', lat: 30.4206, lon: -9.5983, alt: 350, pitch: -30, heading: 0, buildingHeight: 10 },
      { name: 'Agadir Beach', lat: 30.4167, lon: -9.5981, alt: 500, pitch: -22, heading: 270, buildingHeight: 5 },
      { name: 'Al Massira Airport', lat: 30.325, lon: -9.4131, alt: 1200, pitch: -28, heading: 0, buildingHeight: 18 },
    ],
  },
  ouarzazate: {
    name: 'Ouarzazate',
    pack: 'morocco',
    groundElevation: 1150,
    viewBounds: { southwest: { lat: 30.88, lng: -6.95 }, northeast: { lat: 31.00, lng: -6.84 } },
    pois: [
      { name: 'Atlas Studios', lat: 30.9336, lon: -6.8872, alt: 700, pitch: -28, heading: 90, buildingHeight: 18 },
      { name: 'Kasbah Taourirt', lat: 30.9203, lon: -6.8936, alt: 380, pitch: -25, heading: 180, buildingHeight: 16 },
      { name: 'Noor Solar Complex', lat: 31.0094, lon: -6.8647, alt: 1600, pitch: -30, heading: 0, buildingHeight: 40 },
      { name: 'Ait Benhaddou', lat: 31.0472, lon: -7.1319, alt: 500, pitch: -25, heading: 90, buildingHeight: 20 },
      { name: 'Ouarzazate Airport', lat: 30.9392, lon: -6.9094, alt: 1100, pitch: -28, heading: 270, buildingHeight: 12 },
    ],
  },
  meknes: {
    name: 'Meknes',
    pack: 'morocco',
    groundElevation: 530,
    viewBounds: { southwest: { lat: 33.86, lng: -5.59 }, northeast: { lat: 33.92, lng: -5.51 } },
    pois: [
      { name: 'Bab Mansour', lat: 33.8945, lon: -5.5647, alt: 320, pitch: -25, heading: 0, buildingHeight: 16 },
      { name: 'Place el-Hedim', lat: 33.8936, lon: -5.5661, alt: 380, pitch: -30, heading: 180, buildingHeight: 8 },
      { name: 'Mausoleum of Moulay Ismail', lat: 33.8917, lon: -5.5669, alt: 300, pitch: -28, heading: 90, buildingHeight: 14 },
      { name: 'Heri es-Souani', lat: 33.8814, lon: -5.5606, alt: 420, pitch: -30, heading: 0, buildingHeight: 12 },
      { name: 'Volubilis', lat: 34.0739, lon: -5.5556, alt: 500, pitch: -28, heading: 180, buildingHeight: 8 },
    ],
  },
  essaouira: {
    name: 'Essaouira',
    pack: 'morocco',
    groundElevation: 10,
    viewBounds: { southwest: { lat: 31.50, lng: -9.78 }, northeast: { lat: 31.53, lng: -9.75 } },
    pois: [
      { name: 'Skala de la Ville', lat: 31.5139, lon: -9.7744, alt: 280, pitch: -22, heading: 270, buildingHeight: 10 },
      { name: 'Essaouira Medina', lat: 31.5125, lon: -9.7699, alt: 350, pitch: -30, heading: 90, buildingHeight: 12 },
      { name: 'Essaouira Port', lat: 31.5086, lon: -9.7747, alt: 300, pitch: -25, heading: 180, buildingHeight: 8 },
      { name: 'Essaouira Beach', lat: 31.5061, lon: -9.7664, alt: 450, pitch: -22, heading: 270, buildingHeight: 4 },
      { name: 'Mogador Island', lat: 31.4958, lon: -9.7853, alt: 700, pitch: -25, heading: 0, buildingHeight: 6 },
    ],
  },
  chefchaouen: {
    name: 'Chefchaouen',
    pack: 'morocco',
    groundElevation: 600,
    viewBounds: { southwest: { lat: 35.16, lng: -5.28 }, northeast: { lat: 35.18, lng: -5.255 } },
    pois: [
      { name: 'Plaza Uta el-Hammam', lat: 35.1714, lon: -5.2697, alt: 280, pitch: -25, heading: 180, buildingHeight: 10 },
      { name: 'Chefchaouen Kasbah', lat: 35.1711, lon: -5.2703, alt: 260, pitch: -28, heading: 90, buildingHeight: 12 },
      { name: 'Ras El Maa', lat: 35.1728, lon: -5.2614, alt: 250, pitch: -22, heading: 90, buildingHeight: 6 },
      { name: 'Spanish Mosque', lat: 35.1747, lon: -5.2631, alt: 350, pitch: -20, heading: 220, buildingHeight: 8 },
      { name: 'Blue Medina', lat: 35.1716, lon: -5.2692, alt: 420, pitch: -32, heading: 45, buildingHeight: 10 },
    ],
  },
  tetouan: {
    name: 'Tetouan',
    pack: 'morocco',
    groundElevation: 90,
    viewBounds: { southwest: { lat: 35.56, lng: -5.39 }, northeast: { lat: 35.59, lng: -5.35 } },
    pois: [
      { name: 'Tetouan Medina', lat: 35.5711, lon: -5.3684, alt: 320, pitch: -28, heading: 180, buildingHeight: 12 },
      { name: 'Place Hassan II', lat: 35.5706, lon: -5.3689, alt: 300, pitch: -25, heading: 90, buildingHeight: 10 },
      { name: 'Royal Palace Tetouan', lat: 35.5719, lon: -5.3711, alt: 400, pitch: -28, heading: 270, buildingHeight: 16 },
      { name: 'Ensanche Tetouan', lat: 35.5736, lon: -5.3725, alt: 350, pitch: -30, heading: 0, buildingHeight: 14 },
      { name: 'Sania Ramel Airport', lat: 35.5943, lon: -5.32, alt: 1100, pitch: -28, heading: 90, buildingHeight: 12 },
    ],
  },
  kenitra: {
    name: 'Kenitra',
    pack: 'morocco',
    groundElevation: 25,
    viewBounds: { southwest: { lat: 34.24, lng: -6.62 }, northeast: { lat: 34.29, lng: -6.55 } },
    pois: [
      { name: 'Kenitra Station', lat: 34.261, lon: -6.5802, alt: 320, pitch: -28, heading: 0, buildingHeight: 14 },
      { name: 'Kenitra Medina', lat: 34.2611, lon: -6.5806, alt: 350, pitch: -30, heading: 180, buildingHeight: 10 },
      { name: 'Lac Sidi Boughaba', lat: 34.2556, lon: -6.6681, alt: 700, pitch: -28, heading: 270, buildingHeight: 4 },
      { name: 'Mehdia Beach', lat: 34.2583, lon: -6.6819, alt: 500, pitch: -22, heading: 270, buildingHeight: 5 },
      { name: 'Kenitra Port', lat: 34.2639, lon: -6.5083, alt: 800, pitch: -28, heading: 90, buildingHeight: 12 },
    ],
  },
};
